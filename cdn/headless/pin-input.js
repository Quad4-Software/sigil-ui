...
export function attachPinInput(root, options = {}) {
    const cells = [...root.querySelectorAll('.sig-pin-cell, input')];
    if (!cells.length)
        throw new Error('sigil: attachPinInput needs .sig-pin-cell inputs');
